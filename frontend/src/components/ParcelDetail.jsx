  ...
  return (
    <aside className="card parcel-detail">
      ...
      <div className="parcel-grid">
        <div className="stat"><div className="v">~{Number(parcel.area_m2 ?? parcel.area ?? 0).toLocaleString()} m²</div><div className="l">Estimated area ({Number(parcel.area_ha ?? (parcel.area_m2 ?? parcel.area ?? 0) / 10000).toFixed(4)} ha)</div></div>
        ...
        <div className="stat"><div className="v">{Number(parcel.confidence ?? 0).toFixed(2)}</div><div className="l">AI confidence (heur.)</div></div>
